...
- 2026-03-30: Plan 3 / Task 2 添加 openpyxl 依赖时，pip install -e '.[dev]' 因 setuptools 将 pp 与 lembic 同时识别为顶层包而失败；当前环境已存在 openpyxl 3.1.2，因此先继续执行 parser 开发，后续需要单独修复打包配置。